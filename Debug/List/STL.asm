...
; 0000 0023 // Function: Bit7=In Bit6=In Bit5=Out Bit4=Out Bit3=Out Bit2=Out Bit1=Out Bit0=Out
; 0000 0024 DDRB=(0<<DDB7) | (0<<DDB6) | (1<<DDB5) | (1<<DDB4) | (1<<DDB3) | (1<<DDB2) | (1<<DDB1) | (1<<DDB0);
	LDI  R30,LOW(63)
	OUT  0x17,R30
; 0000 0025 // State: Bit7=T Bit6=T Bit5=0 Bit4=0 Bit3=0 Bit2=0 Bit1=0 Bit0=0
...
; 0000 002F // Function: Bit7=In Bit6=In Bit5=Out Bit4=Out Bit3=Out Bit2=Out Bit1=Out Bit0=Out
; 0000 0030 DDRD=(0<<DDD7) | (0<<DDD6) | (1<<DDD5) | (1<<DDD4) | (1<<DDD3) | (1<<DDD2) | (1<<DDD1) | (1<<DDD0);
	LDI  R30,LOW(63)
	OUT  0x11,R30
; 0000 0031 // State: Bit7=T Bit6=T Bit5=0 Bit4=0 Bit3=0 Bit2=0 Bit1=0 Bit0=0
...
; 0000 0084         PORTD.3 = 0;
	CBI  0x12,3
; 0000 0085         PORTD.4 = 1;  // YELLOW BLINKING BEFORE RED <START>
	RCALL SUBOPT_0x0
; 0000 0086         PORTB.4 = 1;
...
; 0000 0094         PORTD.4 = 0;
; 0000 0095         PORTB.4 = 0;
; 0000 0096         delay_ms(500); // YELLOW BLINKING BEFORE RED <END>
; 0000 0097         PORTD.5 = 1;
	SBI  0x12,5
; 0000 0098         PORTB.5 = 1;
	SBI  0x18,5
...
; 0000 009F         PORTB.2 = 0;
	CBI  0x18,2
; 0000 00A0         PORTD.1 = 1;   // YELLOW BLINKING BEFORE RED <START>
	RCALL SUBOPT_0x1
; 0000 00A1         PORTB.1 = 1;
...
; 0000 00AF         PORTD.1 = 0;
; 0000 00B0         PORTB.1 = 0;
; 0000 00B1         delay_ms(500); // YELLOW BLINKING BEFORE RED <END>
; 0000 00B2         PORTD.5 = 0;
	CBI  0x12,5
; 0000 00B3         PORTB.5 = 0;
	CBI  0x18,5
